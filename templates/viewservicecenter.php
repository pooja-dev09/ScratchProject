                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <center><u><h2 class="pageheader-title">Service Center</h2></u></center>
										...
										{% for r in result %}
                                            <tr>
                                               ...
                                               <td>{{r["District"]}}</td>
												...
												<td>{{r["workingfor"]}}</td>
												<td>{{r["EmployeeId"]}}</td>
												<td>{{r["addedbyemployeeid"]}}</td>

                                                <td><a style="color:#ff001a;text-decoration: underline;"href="/viewscdetails/{{r.UserID}}">View</a></td>
