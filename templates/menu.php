                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="/seadmin/index"><i class="fa fa-fw fa-user-circle"></i>Dashboard <span class="badge badge-success">6</span></a>
							...
							<ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/seadmin/claim"><i class="fa fa-fw fa-rocket"></i>Claim Approval</a>                                       
